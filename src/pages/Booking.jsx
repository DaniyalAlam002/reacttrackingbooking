      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Complete the form for a personalized consultation and join the trusted healthcare network. Our experts prioritize your health with responsive and patient-focused service.
          </p>
